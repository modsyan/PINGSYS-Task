namespace MySereneApp;

[NestedLocalTexts]
public static partial class Texts
{
    public static string GetKey<T>(this T name) where T : class
    {
        var field = typeof(T).GetField(name.ToString());
        var property = typeof(T).GetProperty(name.ToString());
    ...
    public static class Forms
    {
        public static class Membership
        {
            ...
            {
                public static readonly LocalText ActivateEmailSubject = "Activate Your MySereneApp Account";
        ...
        {
            public static readonly LocalText FirstName = "First Name";
            public static readonly LocalText LastName = "Last Name";
            public static readonly LocalText BirthDate = "Birth Of Date";
            public static readonly LocalText Gender = "Gender";
            public static readonly LocalText Certificates = "Certificates";
            public static readonly LocalText CertificatesCount = "No. Certificates";
            public static readonly LocalText IsActive = "Is Active";
        }

        public static class Common
        {
            public static readonly LocalText Male = "Male";
            public static readonly LocalText Female = "Female";
        }

        public static readonly LocalText SiteTitle = "MySereneApp";
    }
    ...
    public static class Site
    {
        public static class AccessDenied
        {
            ...
            public static readonly LocalText LackPermissions =
    ...
    public static partial class Validation
    {
        ...
        public static readonly LocalText MinRequiredPasswordLength =
            "Entered password doesn't have enough characters (min {0})!";
        ...
        public static readonly LocalText InvalidResetToken =
            "Your token to reset your password is invalid or has expired!";

        public static readonly LocalText InvalidActivateToken =
            "Your token to activate your account is invalid or has expired!";
